...
summary: Récupérer une application pour un cluster géré 
---
= Récupérer une application pour un cluster géré
:allow-uri-read: 
...
Renvoie la ressource API de l'application stockée dans le corps de la réponse JSON.
