...
summary: 'Liste des utilisateurs d"un groupe' 
---
...
| articles | tableau[N'importe lequel de : link:#user_1_2_get_response_body["corps de réponse user_1.2_get_response_body"], tableau[]] | Vrai  a| 
