...
summary: 'Récupérer une ressource d"application pour un instantané d"application et une application' 
---
= Récupérer une ressource d'application pour un instantané d'application et une application
:allow-uri-read: 
