...
| articles | tableau[N'importe lequel de : link:#cluster_1_6_get_response_body["corps de réponse cluster_1.6_get_response_body"], tableau[]] | Vrai  a| 
...
|===
[role="api-collapsible-fifth-title"]
corps de réponse cluster_1.6_get_response_body
