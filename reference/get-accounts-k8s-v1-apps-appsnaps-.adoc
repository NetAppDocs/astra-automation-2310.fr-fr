...
summary: 'Récupérer un instantané de l"application' 
---
= Récupérer un instantané de l'application
:allow-uri-read: 
...
Renvoie la ressource API Application Snapshot stockée dans le corps de la réponse JSON.
...
ID de la appSnap collection à lister
