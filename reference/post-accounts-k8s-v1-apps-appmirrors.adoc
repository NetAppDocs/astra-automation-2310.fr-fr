...
summary: Créer une nouvelle ressource AppMirror pour une application 
---
= Créer une nouvelle ressource AppMirror pour une application
:allow-uri-read: 


[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/accounts/{account_id}/k8s/v1/apps/{app_id}/appMirrors`#

Indique les valeurs souhaitées pour la ressource API AppMirror à créer.
