...
summary: Récupérer un utilisateur pour un groupe 
---
= Récupérer un utilisateur pour un groupe
:allow-uri-read: 


[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/accounts/{account_id}/core/v1/groups/{group_id}/users/{user_id}`#

Renvoie la ressource API utilisateur stockée dans le corps de la réponse JSON.
