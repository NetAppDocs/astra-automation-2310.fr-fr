...
| articles | tableau[N'importe lequel de : link:#managedCluster_1_3_get_response_body["corps de réponse managedCluster_1.3_get_response_body"], tableau[]] | Vrai  a| 
...
[role="api-collapsible-fifth-title"]
corps de réponse managedCluster_1.3_get_response_body
